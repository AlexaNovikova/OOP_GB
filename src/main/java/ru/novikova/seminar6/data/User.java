...
public class User {
    ...
    // open close principle - классы закрыты для модификации, но открыты для расширения.
    // Поведение класса неотзя изменить, но можно от него наследоваться и изменять поведение наследников
